...
testpy: ## Clean and Make unit tests
	python -m pytest -v ipyregulartable/tests --junitxml=python_junit.xml --cov=ipyregulartable --cov-report=xml:.coverage.xml --cov-branch --cov-fail-under=20 --cov-report term-missing
